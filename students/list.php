...
<body>
    ...
    <div class="container">
        ...
        <a href="add.php" class="btn-link">Add New Student</a>
        <table class="table">
            <thead>
                <tr>
                    <th>STT</th>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td>{$row['email']}</td>
                                <td>
                                    <a href='detail.php?id={$row['id']}' class='btn'>View Details</a>
                                    <a href='edit.php?id={$row['id']}' class='btn'>Edit</a>
                                    <a href='delete.php?id={$row['id']}' class='btn' onclick='return confirm(\"Are you sure you want to delete this student?\")'>Delete</a>
                                </td>
                              </tr>";
                        $stt++;
                    }
